#ifndef ES_APP_MENU_THEME_DATA_H
#define ES_APP_MENU_THEME_DATA_H
#pragma once
...
struct MenuTheme {
	...
	MenuElement title{ 0x555555FF, 0x555555FF, 0x555555FF, 0xFFFFFFFF, "", "", Font::get(FONT_SIZE_LARGE)};
	MenuElement footer{ 0xC6C6C6FF, 0xC6C6C6FF, 0xC6C6C6FF, 0xFFFFFFFF, "", "", Font::get(FONT_SIZE_SMALL)};
	MenuElement text{ 0x777777FF, 0xFFFFFFFF, 0x878787FF, 0xC6C7C6FF, "", "", Font::get(FONT_SIZE_MEDIUM)};
	MenuElement textSmall{ 0x777777FF, 0xFFFFFFFF, 0x878787FF, 0xC6C7C6FF, "", "", Font::get(FONT_SIZE_SMALL)};
...
#endif //ES_APP_MENU_THEME_DATA_H
